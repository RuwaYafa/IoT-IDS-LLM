...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_dropout", type=float, default=0.1, help="lora_dropout to use") #rfa
    parser.add_argument("--weight_decay", type=float, default=0.001, help="weight_decay to use") #rfa

    args = parser.parse_args()
    log_message(f"All args--------------RFA Look: {args}\n--------------End Look")
